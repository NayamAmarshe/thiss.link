...
exports.encryptUrl = void 0;
const encryptUrl = async (url, password) => {
    ...
    const encrypted = new Uint8Array(await crypto.subtle.encrypt({ name: "AES-GCM", iv }, key, textEncoder.encode(url)));
...
//# sourceMappingURL=encrypt-url.js.map